...
import ptdi from '../../assets/ptdi.png';
...
function Projects() {
  ...
  const projectsData = [
    ...
    { src: ptdi, link: "https://portal-dittek.vercel.app/", h3: "Portal Dittek", p: "Sistem portal direktorat teknologi PT Dirgantara Indonesia.", images: [ptdi] },
